package com.siragu.CMex.application;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.siragu.CMex.application.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.siragu.CMex.application.GlideOptions().apply(toSet));
    }
  }
}
