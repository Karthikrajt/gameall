package com.siragu.gameall.application;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.siragu.gameall.application.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.siragu.gameall.application.GlideOptions().apply(toSet));
    }
  }
}
