...
public class UserProfileDetailActivity extends AppCompatActivity {
    ...
    private void setDetails() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(userProfile != null ? userProfile.getName() : userName);
        }
      ...
      //  followingCountContainer.setClickable(userProfile != null && userProfile.getIs_following() == 1);
        followerCountContainer.setClickable(userProfile != null );
        followingCountContainer.setClickable(userProfile != null );
                        ...
                        if (mContext != null) {
                          ...
                          //  followerCountContainer.setClickable(response.isSuccessful() && response.body().isFollowed());
                           // followingCountContainer.setClickable(response.isSuccessful() && response.body().isFollowed());
                            ...
                            followerCountContainer.setClickable(response.isSuccessful() );
                            followingCountContainer.setClickable(response.isSuccessful());
