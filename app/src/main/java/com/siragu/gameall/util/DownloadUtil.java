package com.siragu.gameall.util;
...
public class DownloadUtil {
    ...
    public void checkAndLoad(Context context, DownloadFileEvent downloadFileEvent) {
        ...
        if (file.exists()) {
            ...
            newIntent.setDataAndType(FileProvider.getUriForFile(context, context.getString(R.string.authority), file), FileUtils.getMimeType(context, Uri.fromFile(file)));
